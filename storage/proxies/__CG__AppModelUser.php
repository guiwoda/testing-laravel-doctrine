...
class User extends \App\Model\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'createdBy', 'createdByUser', 'updatedBy', 'ip', 'password', 'rememberToken', 'createdAt', 'updatedAt'];
        }
    ...
    public function whoCreatedYou()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'whoCreatedYou', []);

        return parent::whoCreatedYou();
    }
